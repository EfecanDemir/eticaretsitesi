...
class KategoriController extends Controller
{
    ...
    public function kaydet($id = 0)
    {
        ...
        $this->validate(request(), [
            ...
            'slug'         => (request('original_slug') != request('slug') ? 'unique:kategoriler,slug' : '')
        ]);
    ...
    public function sil($id)
    {
        ...
        if ($kategori_urun_adet>0)
        {
            return redirect()
                ...
                ->with('mesaj', "Bu kategoride $kategori_urun_adet adet ürün var.Silme işlemi gerçekleştirilemedi.")
