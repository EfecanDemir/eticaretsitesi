            ...
            <div class="col-md-3">
                <div class="panel panel-default">
                    ...
                    <div class="list-group categories">
                        @foreach($kategoriler2 as $kategori)
                    ...
                    <div class="row">
                        @foreach($urunler_one_cikan as $urun)
                            <div class="col-md-3 product">
                                <a href="{{route('urun',$urun->slug)}}"><img src="{{ $urun->detay->urun_resmi!=null ? asset('uploads/urunler/' . $urun->detay->urun_resmi) : 'http://via.placeholder.com/640x400?text=UrunResmi' }}" class="img-responsive" style="min-width: 100%;"></a>
