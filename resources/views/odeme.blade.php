...
@section('content')
    <div class="container">
        <div class="bg-content">
            <h2>Ödeme</h2>
            <form action="{{route('odemeyap')}}" method="post" content="{{ csrf_token() }}">
                {{csrf_field()}}
            <div class="row">
                <div class="col-md-5">
                ...
                <div class="col-md-7">
                    ...
                    <div class="row">
                        ...
                        <input type="text" class="form_control" name="adsoyad" id="adsoyad" value="{{auth()->user()->adsoyad}}" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form_group">
                                <label for="adres">Adres</label>
                                <input type="text" class="form_control" name="adres" id="adres" value="{{$kullanici_detay->adres}}" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form_group">
                                ...
                                <input type="text" class="form_control telefon" name="telefon" id="telefon" value="{{$kullanici_detay->telefon}}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form_group">
                                <label for="ceptelefonu">Cep Telefonu</label>
                                <input type="text" class="form_control telefon" name="ceptelefonu" id="ceptelefonu" value="{{$kullanici_detay->ceptelefonu}}" required>
                            </div>
                        </div>
                    </div>
                </div>
